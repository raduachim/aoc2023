...
describe.only('day3', () => {
  ...
  it.skip('works to parse the input', () => {
    const expected = [
      ['4', '6', '7', '.', '.', '1', '1', '4', '.', '.'],
      ['.', '.', '.', '*', '.', '.', '.', '.', '.', '.'],
      ['.', '.', '3', '5', '.', '.', '6', '3', '3', '.'],
  ...
  it.skip('works to find all numbers in a matrix', () => {
  ...
  it.skip('works to find all special characters in a matrix', () => {
  ...
  // it.skip('works to find coordinates for all digits around the coordinates of a special character', () => {
  //   const specialCharactersCoordinates = findSpecialCharacters(matrix)
  ...
  //   ])
  // })
  // it.skip('works to find a number in a matrix by coordinates of a digit', () => {
  //   const numbers = findNumbers(matrix)
  ...
  // it.only('works part1 for real input', () => {
  //   const result = part1()

  //   expect(result).toEqual(440636)
  // })
})
